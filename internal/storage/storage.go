...
import (
	...
	"github.com/randomurban/image-previewer/internal/cache"
)
...
func NewStorage(path string, capacity int) *FileCache {
	return &FileCache{
		path:     path,
		capacity: capacity,
...
func (s *FileCache) Upload(name string, r io.Reader) error {
